...
HcalElectronicsMap::HcalElectronicsMap(const std::vector<PrecisionItem>& pItems, const std::vector<TriggerItem>& tItems) :
  mPItems(pItems),
  mTItems(tItems)
{
  initialize();
...
HcalElectronicsMap::HcalElectronicsMap(const HcalElectronicsMap::Helper& helper) :
  HcalElectronicsMap(helper.mPItems,helper.MTItems)
{}
