...
{
	produces<HGCalDigiCollection>("HGCDigisEE");
	produces<HGCalDigiCollection>("HGCDigisHEfront");
	produces<HGCalDigiCollection>("HGCDigisHEback");
}
...
void HGCDigiConverter::produce(edm::StreamID, edm::Event& iEvent, const edm::EventSetup& iSetup) const {
	...
	iEvent.put(std::move(out_ee),"HGCDigisEE");
	...
	iEvent.put(std::move(out_fh),"HGCDigisHEfront");
	...
	iEvent.put(std::move(out_bh),"HGCDigisHEback");
}
