...
// Tue Nov 22 09:29:51 2016 by ROOT version 6.06/09
// from TTree tree/Hcal SiPM ntuple
// found on file: step2prec10K_HcalSiPMntuple.root
//////////////////////////////////////////////////////////
...
#ifdef SiPMClass_cxx
SiPMClass::SiPMClass(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("step2prec10K_HcalSiPMntuple.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("step2prec10K_HcalSiPMntuple.root");
      }
...
Int_t SiPMClass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SiPMClass::LoadTree(Long64_t entry)
{
...
void SiPMClass::Init(TTree *tree)
{
...
void SiPMClass::Show(Long64_t entry)
{
...
Int_t SiPMClass::Cut(Long64_t entry)
{
