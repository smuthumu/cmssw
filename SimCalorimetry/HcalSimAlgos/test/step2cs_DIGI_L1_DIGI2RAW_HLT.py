...
process.MessageLogger.categories.append("DebugCaloSamples")
...
process.MessageLogger.cout.HcalSiPMntuple = cms.untracked.PSet(limit = cms.untracked.int32(0))
process.MessageLogger.cout.DebugCaloSamples = cms.untracked.PSet(limit = cms.untracked.int32(-1))
