...
def customisePostLS1(process,displayDeprecationWarning=True):
    if displayDeprecationWarning :
        ...
        #       2) add "from Configuration.StandardSequences.Era_Run2_25ns_cff import Run2_25ns" to the TOP of the config file (above
...
def customisePostLS1_50ns(process,displayDeprecationWarning=True):
    if displayDeprecationWarning :
        ...
        #       2) add "from Configuration.StandardSequences.Era_Run2_50ns_cff import Run2_50ns" to the TOP of the config file (above
        #          the process declaration).
...
def customisePostLS1_HI(process,displayDeprecationWarning=True):
    if displayDeprecationWarning :
        ...
        #       2) add "from Configuration.StandardSequences.Era_Run2_HI_cff import Run2_HI" to the TOP of the config file (above
        #          the process declaration).
