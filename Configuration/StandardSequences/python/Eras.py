...
class Eras (object):
    ...
    def __init__(self):
        ...
        self.Phase2LReco = cms.ModifierChain( self.phase2_common, self.phase2_tracker, self.phase2_hgcal, self.phase2_muon, self.run3_GEM )
        self.Phase2GReco = cms.ModifierChain( self.phase2_tracker, self.phase2_muon, self.run3_GEM ) # run 2 calorimeters
