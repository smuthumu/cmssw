...
upgradeScenToRun={ '2017':['GenSimFull','DigiFull','RecoFull','HARVESTFull'],
		   ...
		   '2023tilted':['GenSimFull','DigiFull','RecoFull'],#full (or almost..) reco tilted scenario
		   '2023sim':['GenSimFull'],#sim scenario
		   '2023LReco':['GenSimFull','DigiFull','RecoFullLocal'],#local reco scenario
		   '2023GReco':['GenSimFull','DigiFull','RecoFull'],#full (or almost..)  reco scenario
		   '2023GRecoPU':['GenSimFull','DigiFullPU','RecoFullPU'],#full (or almost..)  reco scenario with PU
		   '2023tiltedPU':['GenSimFull','DigiFullPU','RecoFullPU'],#full (or almost..) reco tilted scenario with PU
