...
upgradeScenToRun={ '2017':['GenSimFull','DigiFull','RecoFull','HARVESTFull'],
		   ...
		   '2023tilted':['GenSimFull','DigiFull','RecoFull','HARVESTFull_trackingOnly'],#full (or almost..) reco tilted scenario
