...
#run2_50ns_specific.toModify(patPFMetTxyCorr, parameters=patMultPhiCorrParams_Txy_50ns )
#from Configuration.Eras.Modifier_run2_25ns_specific_cff import run2_25ns_specific
#run2_25ns_specific.toModify(patPFMetTxyCorr, parameters=patMultPhiCorrParams_Txy_25ns )
